...
public class TestRulesController extends BaseController{
    ...
    @RequestMapping(value="/testsentence", method = RequestMethod.GET)
    public TreeSet<TemporalExtraction> testsentence(@RequestBody String sentence) throws Exception {
        ...
        String text = sentence.replace("<text>", "").replace("</text>", "").replace("?", "-").replace("�", "-").trim();
        System.out.println(text);
    ...
    /*    
    @GetMapping("/testsentence/{sentence}")
    public TreeSet<TemporalExtraction> testsentence(@PathVariable String sentence) throws Exception {
    ...
    public TreeSet<TemporalExtraction> test(@Valid @RequestBody Deneme sen) throws Exception {
    ...
    public String process(@Valid @RequestBody Deneme sentence) throws Exception {
