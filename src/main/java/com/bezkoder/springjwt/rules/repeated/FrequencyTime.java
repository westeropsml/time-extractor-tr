...
public class FrequencyTime extends ExtractionRule {
    ...
    private String rule = "\\b(" + TemporalConstants.DURATION + ")(lik|lık|luk|lük)\\b";

    protected String example = "saatlik, günlük, haftalık, aylık, yıllık, bir yıllık, senelik";
    protected String exampleEn = "daily, weekly, monthly, annualy, hourly, etc.";
    ...
    public List<Temporal> getTemporal(String text) {
        ...
        Temporal temporal = parser.getTemporalForEveryPeriod(m.group(1));
