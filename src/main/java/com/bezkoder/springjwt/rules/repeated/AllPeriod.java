...
public class AllPeriod extends ExtractionRule {
    ...
    private String rule = "\\b((bütün|tüm)[\\s]*(" + TemporalConstants.DURATION + "))\\b";

    protected String example = "bütün sene, tüm gün, bütün ay, bütün hafta";
    protected String exampleEn = "whole year, all day, full month, entire week";
