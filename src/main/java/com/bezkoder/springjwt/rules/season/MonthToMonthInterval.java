...
public class MonthToMonthInterval extends ExtractionRule {
    ...
    //private String rule = "\\b(" + TemporalConstants.SEASON + ")([\\s]*(ayı|ayları|saati|saatleri))?\\b\\b(" + TemporalConstants.SEASON + ")([\\s]*(ayı|ayları|saati|saatleri))?\\b";
    private String rule = "\\b(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + "|" + TemporalConstants.SEASON + ")[\\s]*((ayı|ayları|saati|saatleri)[\\s]*)?([\\s]*[\\w]*[\\s]*)?(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + "|" + TemporalConstants.SEASON + ")[\\s]*((ayı|ayları|saati|saatleri)[\\s]*)?\\b";
    private String ruleEn = "\\b((between|from)[\\s]*(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + "|" + TemporalConstants.SEASON + ")([\\s]*(and|to)[\\s]*)(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + "|" + TemporalConstants.SEASON + "))";

    protected String example = "yaz ayıyla sonbahar ayları, ocak ayıyla şubat ayı, ocak ayıyla şubat arası";
    protected String exampleEn = "from winter to summer, from January to spring";
