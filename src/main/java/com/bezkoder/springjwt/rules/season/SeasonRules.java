...
public class SeasonRules extends ExtractionRule {
    ...
    protected String example = "ilkbahar ayları, yaz saatleri";
    protected String exampleEn = "summer, fall, summer hours, winter months, etc.";
    ...
    public List<Temporal> getTemporal(String text) {
        ...
        Temporal temporal = parser.getSeason(m.group(1), 0);
