...
public class SeasonRules2 extends ExtractionRule {
    ...
    private String rule = "\\b(sonbahar|kış|ilkbahar|yaz|bahar)[\\s]*((([1][8-9])|([2][012]))\\d\\d)\\b";
    private String ruleEn = "\\b(fall|winter|summer|spring|autumn)[\\s]*([2][0-9]\\d\\d)\\b";
    
    protected String example = "ilkbahar 2014, kış 2015";
    protected String exampleEn = "fall 2014, winter 2015";
