...
public class TimeIntervalRule8 extends ExtractionRule {
    ...
    private String rule="\\b([0-9]|0[0-9]|1[0-9]|2[0-3])([:.]([0-5][0-9]))?[\\/]([0-9]|0[0-9]|1[0-9]|2[0-3])[:.]([0-5][0-9])";
    private String ruleEn = "\\b(0?[0-9]|1[0-9]|2[0-3])[\\/]([0-9]|0[0-9]|1[0-9]|2[0-3])[:.]([0-5][0-9])";
