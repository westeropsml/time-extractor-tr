...
public class TimeIntervalRule3 extends ExtractionRule {
    ...
    private String ruleEn = "\\b((after|before|until|till|til|by)[\\s]*([01]?[0-9]|2[0-3])([\\s]*[.|:]([0-5][0-9]))?)\\b";
    private String rule = "\\b([01]?[0-9]|2[0-3])([\\s]*[.|:]([0-5][0-9]))?(\\s*|')(den|dan|ten|tan)\\s(önce|sonra)|([01]?[0-9]|2[0-3])([\\s]*[.|:]([0-5][0-9]))?(\\s?|')(e|a|ye|ya)\\s(kadar)\\b";

    protected String exampleEn = "after 11.30, till 20:00, before 11.20";
    protected String example = "11.30'dan önce,  11.30'a kadar., 11:30dan sonra., 11:30 a kadar";
    ...
    public List<Temporal> getTemporal(String text) {
        ...
        if (m.group(3) != null) {
            time.setMinutes(Integer.parseInt(m.group(3)));
        }
        TimeTag tag = TemporalBasicCaseParser.getTimeTag(m.group(6));
