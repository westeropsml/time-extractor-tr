...
public class WeekEnd extends ExtractionRule {
    ...
    private String rule = "\\b((hafta)([\\s]*)(sonu|sonları|sonuları|sonlari|sonulari))\\b";
    private String ruleEn = "\\b(weekend|weekends|week-end|week-ends)\\b";
    protected int priority = 1;
    protected String example = "hafta sonu, hafta sonları";
    protected String exampleEn = "weekend, week-end, etc.";
