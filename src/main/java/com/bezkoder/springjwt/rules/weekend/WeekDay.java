...
public class WeekDay extends ExtractionRule {
    ...
    private String rule = "\\b((hafta)([\\s]*)(içi|içisi|içleri|içileri|içisileri))\\b";
    private String ruleEn = "\\b(week days|week day|week days|week day|weekday|weekdays|week-days|week-day)\\b";
    protected int priority = 1;
    protected String example = "hafta içi, hafta içleri";
    protected String exampleEn = "week days, weekday, etc. ";
