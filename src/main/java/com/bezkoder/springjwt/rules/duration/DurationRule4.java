...
public class DurationRule4 extends ExtractionRule {
    ...
    private String ruleEn="((en az(ından|ı)?|en fazla)[\\s]*)(bir[\\s]*)?(([\\d]{1,})[\\s]*(saat|sa))([\\s]*([\\d]{1,})[\\s]*(dakika|dk|dakka))([\\s]*(falan|gibi))?([\\s]*sür)";
    ...
    protected String exampleTr = "en azından 12 saat 2 dakika sürer";
