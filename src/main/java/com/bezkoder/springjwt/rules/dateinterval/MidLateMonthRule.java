...
public class MidLateMonthRule extends ExtractionRule {
    ...
    private String rule = "\\b(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + ")((')?(ın|un|ün|in))?([\\s]*)(ortası)\\b";
    private String ruleEn = "\\b(mid|mid-late)[-\\s]*((" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + ")[s]?([.])?)";
    protected int priority = 3;

    protected String example = "mayıs'ın ortası, haziran ortası";
    protected String exampleEn = "mid May, mid-late June";
