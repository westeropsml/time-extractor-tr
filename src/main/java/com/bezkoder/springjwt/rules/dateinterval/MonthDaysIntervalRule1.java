...
public class MonthDaysIntervalRule1 extends ExtractionRule {
    ...
    private String rule = "\\b(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + ")(')?(tan|dan|den)([\\s]*)(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + ")(')?(a|e)(([\\s]*)(kadar))?\\b";
    private String ruleEn = "\\b((" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + ")[.]?)[\\s]*(([3][0-1]|[1-2][0-9]|[1-9])[\\s]*(th|st|rd|nd)?[\\s]*[-][\\s]*([3][0-1]|[1-2][0-9]|[1-9])(th|st|rd|nd)?)([\\s]*[,]?[\\s]*([2][0-9]\\d\\d))?";
    
    protected String example = "Ocaktan Şubata kadar, Ocaktan şubata";
    protected String exampleEn = "Jul 28th-31st 2014";
