...
public class DayOfWeekIntervalRule2 extends ExtractionRule {
    ...
    private String rule = "\\b(" + TemporalConstants.DAY_OF_WEEK + "|" + TemporalConstants.DAY_OF_WEEK_EASY + ")[\\s]*(,|-|.|\\/)?[\\s]*(" + TemporalConstants.DAY_OF_WEEK + "|" + TemporalConstants.DAY_OF_WEEK_EASY + ")\\b";
    private String ruleEn = "\\b" + "(" + TemporalConstants.DAY_OF_WEEK + "|" + TemporalConstants.DAY_OF_WEEK_EASY + ")" + "\\/" + "(" + TemporalConstants.DAY_OF_WEEK + "|" + TemporalConstants.DAY_OF_WEEK_EASY + ")";
    
    protected String example = "Paz/Sal, Pazartesi/Pazar";
    protected String exampleEn = "Mon/Tue";
    ...
    public List<Temporal> getTemporal(String text) {
        ...
        DayOfWeek startDayOfWeek = TemporalBasicCaseParser.getDayOfWeek(m.group(1));
        DayOfWeek endDayOfWeek = TemporalBasicCaseParser.getDayOfWeek(m.group(5));
