...
public class TimeOfDayRule extends ExtractionRule {
    ...
    protected String example = "sabah, sabah saatleri, öğleden sonra, akşam, gece, öğle saatleri, gece yarısı, öğle yemeği zamanı";
    protected String exampleEn = "time of day: morning, evening, etc.";
