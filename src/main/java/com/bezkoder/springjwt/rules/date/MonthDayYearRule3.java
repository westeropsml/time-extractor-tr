...
public class MonthDayYearRule3 extends ExtractionRule {
    ...
    protected String rule = "((19|20)\\d{2})(((,)|(-)|(.)|(\\/))?[\\s]*)(([0]?|[12])[0-9])(((,)|(-)|(.)|(\\/))?[\\s]*)(([1-2][0-9])|([3][0-1])|([0][1-9]))";
    protected String ruleEn = "\\b((in|on|by|until)[\\s]*)?((([12][0-9])\\d\\d)[-.\\/]((1[012]|0?[1-9]))[-.\\/]((3[01]|[12][0-9]|0[1-9])))\\b";
    
    protected String example = "2014-02-29, 2013-01-01";
    protected String exampleEn = "until 2014-02-29, 2011-02-03, by 2013-01-01";
    ...
    public List<Temporal> getTemporal(String text) {
        ...
        String monthString = m.group(9);
        String dayString = m.group(17);
