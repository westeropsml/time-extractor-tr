...
public class NTimeAgoRule extends ExtractionRule {
    ...
    protected String rule ="\\b([\\d]{1,})[\\s]*(" + TemporalConstants.DURATION + ")[\\s]*(önce)";
    protected String ruleEn = "\\b([\\d]{1,})[\\s]*(" + TemporalConstants.DURATION + ")[\\s]*(ago)\\b";
    
    protected String example = "10 ay önce, 11 yıl önce, 123 dakika önce vs.";
    protected String exampleEn = "10 month ago, 11 years ago, 123 minutes ago, etc.";
