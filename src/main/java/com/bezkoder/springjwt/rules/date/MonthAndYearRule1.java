...
public class MonthAndYearRule1 extends ExtractionRule {
    ...
    private String rule = "\\b(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + ")[.]?([\\s]*)(([12][0-9])?(\\d\\d))\\b";
    
    protected String example = "Ekim 2012, Eki. 2014, Şub. 2014";
    protected String exampleEn = "October 2012, Oct. 2014, Feb. 2014";
