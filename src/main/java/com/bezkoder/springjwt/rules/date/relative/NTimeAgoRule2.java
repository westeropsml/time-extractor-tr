...
public class NTimeAgoRule2 extends ExtractionRule {
    ...
    protected String rule = "\\b(" + TemporalConstants.BASIC_NUMBER_ONE_TEN + "|" + TemporalConstants.BASIC_NUMBER_TWENTY_HUNDRED + "|" + TemporalConstants.BASIC_NUMBER_ELEVEN_NINETEEN + ")[\\s]*(" + TemporalConstants.DURATION + ")[\\s]*(önce)\\b";
    protected String ruleEn = "\\b" + "((" + TemporalConstants.BASIC_NUMBER_ONE_TEN + "|" + "([\\s]*" + TemporalConstants.BASIC_NUMBER_TWENTY_HUNDRED + ")" + "|" + "([\\s]*" + TemporalConstants.BASIC_NUMBER_ELEVEN_NINETEEN + "))[\\s]*((" + TemporalConstants.DURATION + "))[\\s]*(ago))\\b";
    
    protected String example = "bir saat önce, iki hafta önce, yirmi ay önce";
    protected String exampleEn = "one hour ago, two weeks ago, month ago";
