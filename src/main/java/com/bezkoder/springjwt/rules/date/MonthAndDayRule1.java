...
public class MonthAndDayRule1 extends ExtractionRule {
    ...
    //private String rule = "\\b(((([1-2][0-9]|[3][0-1]|[0]?[1-9]))" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + "))[.]?([,]?[\\s]*\\b([12][0-9]\\d\\d)\\b)?\\b";
    private String rule = "\\b(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + ")[\\s]*([1-2][0-9]|[3][0-1]|[0]?[1-9])(.|,)?[\\s]*([12][0-9]\\d\\d)?\\b";

    protected String example = "Haziran 14 2014, Haziran 14";
    protected String exampleEn = " July the 14th 2014, February 14 2014, July 14, August 10, Mar 2014 etc.";
    ...
    public List<Temporal> getTemporal(String text) {
        ...
        int year = 0;
        int month = TemporalBasicCaseParser.getMonthOfYear(m.group(2)).getValue();
