...
public class MonthAndDayRule6 extends ExtractionRule {
    ...
    private String rule = "\\b(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + ")(,|-|.|\\/)(([12][0-9])?(\\d\\d))\\b";
    private String ruleEn = "(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + ")[-](([12][0-9])?(\\d\\d))";

    protected String example = "Oca-2013, Şubat-2015, Mart/2020";
    protected String exampleEn = "Jan-2013, February-2015";
