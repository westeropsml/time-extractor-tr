...
public class DayOfWeekRule2 extends ExtractionRule {
    ...
    private String rule ="\\b(" + TemporalConstants.DAY_OF_WEEK + "|" + TemporalConstants.DAY_OF_WEEK_EASY + ")[.]?[\\s]*([1-2][0-9]|[3][0-1]|[1-9])\\b";
    private String ruleEn = "\\b(" + "(" + TemporalConstants.DAY_OF_WEEK + "|" + TemporalConstants.DAY_OF_WEEK_EASY + ")" + "[.]?[s]?[\\s]*([1-2][0-9]|[3][0-1]|[1-9]))\\b";

    protected String example = "Pazar 16, Pazartesi 14";
    protected String exampleEn = "Sunday 16, Monday 14";
