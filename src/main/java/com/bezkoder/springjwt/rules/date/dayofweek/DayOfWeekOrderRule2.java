...
public class DayOfWeekOrderRule2 extends ExtractionRule {
    ...
    private String rule = "\\b(ayın[\\s]*)?(([1-5])(\\.|(inci)|(ıncı)|(üncü)|(uncu))?[\\s]*)("+TemporalConstants.DAY_OF_WEEK+"|"+TemporalConstants.DAY_OF_WEEK_EASY+")((sı)|(si|(ı)?))?\\b";
    ...
    //private String rulee = "(ayın[\\s]*)?(([1-5])(.|(inci)|(ıncı)|(üncü)|(uncu))?[\\s]*)" + "((" + TemporalConstants.DAY_OF_WEEK + "|" + TemporalConstants.DAY_OF_WEEK_EASY+ "((sı)|(si|(ı)?))?))";

    protected String example = "ayın 1. salısı, 3 üncü pazartesi";
    protected String exampleEn = "1st Tuesday of the month";
    ...
    public List<Temporal> getTemporal(String text) {
        ...
        dayOfWeek = TemporalBasicCaseParser.getDayOfWeek(m.group(9));
