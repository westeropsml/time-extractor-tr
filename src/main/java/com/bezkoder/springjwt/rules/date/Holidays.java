...
public class Holidays extends ExtractionRule {
    ...
    protected String example = "Cadılar Bayramı, Noel Arifesi, Noel Günü, Noel, Yılbaşı, Yılbaşı Arifesi, Bağımsızlık Günü, Şükran Günü, Gaziler Günü, Anma Günü, Açılış Günü, Sevgililer Günü, İşçi Bayramı, 19 Mayıs Bayramı, 15 Temmuz Günü, 30 Ağustos Bayramı, 29 Ekim Bayramı, Sevgililer Günü, Kurban Bayramı, Ramazan Bayramı";
    protected String exampleEn = "Christmas, New Year, Thanksgiving Day, Memorial Day, etc.";
