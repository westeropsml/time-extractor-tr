...
public class DayOfWeekOrderRule1 extends ExtractionRule {
    ...
    private String rule = "((ayın[\\s]*)?(" + TemporalConstants.BASIC_ORDER + ")[\\s]*(" + "(" + TemporalConstants.DAY_OF_WEEK + "|" + TemporalConstants.DAY_OF_WEEK_EASY + ")"+ "))";
    private int priority = 3;
    protected String example = "ayın birinci salısı, ayın üçüncü pazartesisi, son cuma";
    protected String exampleEn = "the first Tuesday, the third Monday of the month, the last Friday";
