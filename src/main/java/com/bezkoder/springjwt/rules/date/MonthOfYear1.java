...
public class MonthOfYear1 extends ExtractionRule {
    ...
    protected String rule = "\\b(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + ")[\\s]*(ayında|'ta| ta| ayı)\\b";
    protected String ruleEn = "\\b((through[\\s]*|thru[\\s]*|in[\\s]*)?(" + TemporalConstants.MONTH_OF_YEAR + "|" + TemporalConstants.MONTH_OF_YEAR_EASY + ")[.]?)\\b";
    
    protected String example = "Aralık ayında, Aralık'ta, Şubat ayı";
    protected String exampleEn = "in December, through Febryary, January, February, etc.";
